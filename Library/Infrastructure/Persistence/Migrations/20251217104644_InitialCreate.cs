    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailableBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AvailableBooks_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AvailableBookId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Borrows_AvailableBooks_AvailableBookId",
                        column: x => x.AvailableBookId,
                        principalTable: "AvailableBooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservations_AvailableBooks_AvailableBookId",
                        column: x => x.AvailableBookId,
                        principalTable: "AvailableBooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailableBooks_BookId",
                table: "AvailableBooks",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_AvailableBooks_InventoryCode",
                table: "AvailableBooks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Borrows_AvailableBookId",
                table: "Borrows",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_AvailableBookId",
                table: "Reservations",
                column: "AvailableBookId");
        }
